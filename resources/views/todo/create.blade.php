                    ...
                    <form method="POST" action="{{ route('todo.store') }}">
                        ...
                        <div class="mb-6">
                            ...
                            <select id="category_id" name="category_id"
                                class="block w-full mt-1 rounded-md shadow-sm border-gray-300 dark:border-gray-700 dark:bg-gray-800 dark:text-white focus:ring focus:ring-indigo-500 focus:ring-opacity-50">
